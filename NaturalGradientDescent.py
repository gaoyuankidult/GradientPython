...
for i in range(500):
    ...
    gradient_vector = \
        matrix(
            [[gradient_beta0(y, predicted_value), gradient_beta1(y, predicted_value, x)]]
        ).T
    fisher_matrix = \
        matrix([
            [1, x.mean()],
    ...
    natural_gradient_vector = inv(fisher_matrix) * gradient_vector
    temp0 = beta0 - learning_rate * \
        natural_gradient_vector[0]
    temp1 = beta1 - learning_rate * \
        natural_gradient_vector[1]
